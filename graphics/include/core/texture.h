        ...
        namespace interf {
            ...
            class Texture {
                ...
                public:
                    ...
                    * @param sizex, sizey : size of the texture data to be set (default is the size of this texture)
                    */
                    virtual void setData(char* data, int byte_size, int depth = 0, int mip_map_level = 0, int offsetx = 0, int offsety = 0, int sizex = -1, int sizey = -1) = 0;
